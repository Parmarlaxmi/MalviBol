...
const Signup = ({ onClose }) => {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    axios.post('https://malvibol-backend.onrender.com/user_reg', user).then(response => {
      ...
      <div className="signup-content">
        ...
        <form className="signupformm">
          ...
          <div className='buttons_S'>
            <button className="usr_reg_btns" type="submit" onClick={handleSubmit}><i class="fa-solid fa-user-plus"></i>  Register</button>
            <button className="usr_reg_btns" type="submit" onClick={handlelogin} ><i class="fa-solid fa-circle-arrow-right"></i> Login</button>
          </div>
        </form>
